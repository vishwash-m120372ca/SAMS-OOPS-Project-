    ...
    public void DoConnect ()
     {        
        ...
        try {
            ...
            st.execute("UPDATE student SET rollno='"+jTextField1.getText()+"' WHERE rollno='"+jTextField2.getText()+"'");            
            st.execute("SELECT rollno FROM student WHERE rollno='"+jTextField1.getText()+"'");
